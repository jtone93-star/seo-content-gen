...
- **AI models / BYO Claude:** http://localhost:3000/settings/models
- **User stories (orphan page):** http://localhost:3000/stories
- **Worker:** optional `npm run worker` (not required; jobs run inline in the API)
