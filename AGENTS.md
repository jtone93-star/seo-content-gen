...
- **Docs:** `docs/USER_STORIES.md`, `docs/ARCHITECTURE.md`, `docs/DEPLOY.md`, `docs/SMOKE_TESTS.md`, `docs/README.md`
- **User stories UI:** `/stories` (orphan — not in `Nav`)
...
- **Hosting:** Vercel + Deployment Protection + Supabase (no separate worker host)